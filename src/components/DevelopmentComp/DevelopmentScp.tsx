...
import thirdPic from './3.svg'
import forthPic from './4.png'
import fivthPic from './5.svg'

import sixthPic from './6.png'
import seventhPic from './7.png'
import eightPic from './8.png'
